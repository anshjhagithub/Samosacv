...
const FREE_ADDONS = [
  { label: "ATS Keyword Booster", desc: "Optimize your resume for ATS" },
  { label: "AI Summary Rewrite", desc: "Professional summary generation" },
  { label: "Cover Letter", desc: "Matching cover letter template" },
  { label: "Mock Interview Pack", desc: "Interview questions & answers" },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }} className="relative rounded-2xl border-2 border-amber-400 bg-gradient-to-br from-amber-50 via-white to-amber-50/30 p-6 shadow-lg shadow-amber-200/30">
                ...
                <div className="mt-5 pt-4 border-t border-amber-200/60">
                  <p className="text-[10px] text-stone-400 uppercase tracking-wider font-semibold mb-2">Free bonus tools</p>
                  <div className="grid grid-cols-2 gap-1.5">
                    {FREE_ADDONS.map((a) => (
                      <div key={a.label} className="flex items-center justify-between rounded-lg bg-emerald-50/80 border border-emerald-100 px-2 py-1.5">
        ...
        {/* ═══ FREE TOOLS SHOWCASE ═══ */}
        <section className="py-14 sm:py-18 bg-gradient-to-br from-emerald-50 via-white to-sky-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <motion.div 
            ...
            >
              <motion.div 
                className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-100 text-emerald-800 rounded-full text-sm font-bold mb-4"
              ...
              <p className="text-lg text-stone-600 max-w-2xl mx-auto">
                No payment required. Access interview prep, ATS optimization, LinkedIn tools, and more to boost your job search.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Role-specific questions with STAR method answers",
                  features: ["15+ questions", "STAR examples", "Salary tips"],
                  color: "violet",
                  delay: 0
                },
                {
                  icon: "🤖",
                  title: "ATS Optimizer",
                  desc: "Get 90+ ATS score with smart keyword optimization",
                  features: ["Action verbs", "Keywords", "Format fixes"],
                  color: "emerald",
                  delay: 0.1
                },
                {
                  ...
                  features: ["Headline rewrite", "About section", "Skills"],
                  color: "blue",
                  delay: 0.2
                },
                {
                  icon: "📄",
                  title: "Cover Letter",
                  desc: "Professional cover letter tailored to your resume",
                  features: ["Custom content", "Professional format", "Ready to use"],
                  color: "sky",
                  delay: 0.3
                },
                {
                  ...
                  features: ["Skill gaps", "Resources", "Timeline"],
                  color: "amber",
                  delay: 0.4
                },
                {
                  ...
                  features: ["Section analysis", "Tips", "Score breakdown"],
                  color: "emerald",
                  delay: 0.5
                }
              ].map((tool, index) => (
                <motion.div
                  ...
                  className="rounded-2xl border border-white bg-white p-6 shadow-lg hover:shadow-xl transition-all"
                >
                  <motion.div 
                  ...
                  <h3 className="text-lg font-bold text-stone-900 mb-2">{tool.title}</h3>
                  <p className="text-sm text-stone-600 mb-4">{tool.desc}</p>
                  <div className="space-y-2 mb-4">
                    {tool.features.map((feature, i) => (
                      <motion.div 
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.4, delay: tool.delay + 0.2 + i * 0.1 }}
            ...
            >
              <motion.div 
                className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-emerald-600 to-sky-600 text-white rounded-xl font-semibold shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <span>Start Using All Free Tools</span>
                <motion.span
                  animate={{ x: [0, 5, 0] }}
              ...
              <p className="text-sm text-stone-500 mt-3">
                Build your resume → Get instant access to all 6 free career tools
              </p>
            </motion.div>
          </div>
        </section>
