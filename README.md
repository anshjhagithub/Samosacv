...
Paste your resume text, upload a PDF resume, or add a job description. AI generates a tailored resume with most fields prefilled. Use smart suggestions to improve bullets and summary. No sign-up required.

## Features

- **AI-generated resume** — Paste resume text or upload a PDF. Optionally paste a job description; the resume is tailored to the role (keywords, emphasis).
...
3. Open [http://localhost:3000](http://localhost:3000):
   - Paste your resume text (or upload a PDF) and optionally a job description, then click **Generate my resume with AI**.
   - Or go through onboarding and choose **Job description**, **Upload PDF**, or **Start from scratch**.
